# Operator Quickstart — Uranium and Thorium Ore Mining Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0721** (`cloud-itonami-isic-0721`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0721.git
cd cloud-itonami-isic-0721
```
...
- Blueprint governor key: `uranium-thorium-mining-governor`
- Likely source path: `uraniumops.governor.cljc`
